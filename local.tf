locals {
  ...
  worker_security_group_id  = var.worker_create_security_group ? aws_security_group.workers_mapped[0].id : var.worker_security_group_id
  ...
  workers_group_defaults_defaults = {
    ...
    root_encrypted                    = true                                     # Whether the volume should be encrypted or not
